...
2. **custom.properties**（[nacos/conf/custom.properties](nacos/conf/custom.properties)）— 挂载到容器的 `/home/nacos/init.d/`，配置 Spring 数据源通过 Docker 网络 DNS 连接到 `postgres:5432/dev-nacos`。
